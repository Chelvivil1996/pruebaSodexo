...
<head>
  ...
  <title>Horarios Digitales</title>
  ...
  <link rel="stylesheet" href="dist/css/AdminLTE.min.css">
      ...
      <div class="wrapper">
        <header class="main-header">
          ...
          <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>HORARIO DIGITAL</b> </span>
          </a>
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="<?=  $usuario->imagenurl;  ?>"  alt="DBA"  style="width:20px;height:20px;">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="user-header">
                      ...
                      <p>
                       ADMIN
                       <small>UCR SEDE DEL PACIFICO</small>
                     </p>
                   </li>
                   <!-- Menu Body -->
                   <li class="user-body">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="javascript:void(0);" onclick="cargarformulario(2);" ><i class="fa fa-circle-o"></i>Agregar aulas </a></li>
                <li class="active"><a href="javascript:void(0);" onclick="cargarlistado(2);" ><i class="fa fa-circle-o"></i>Listado Aulas</a></li>
              </ul>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="javascript:void(0);" onclick="cargarformulario(4);"><i class="fa fa-circle-o"></i>Cargar Datos Aulas.</a></li>
              </ul>
              

            <ul class="treeview-menu">
                <li class="active">
                    <form method="get" action="{{url('form_descargar_datos_aulas')}}">
                      <div class="mc-btn"><span class="contenedor-descarga ">
                         <button class="btn-descarga " type="submit" ><span>Descargar Excel Aulas</span></button>
                      </span>
                      </div>
                    </form>
              </li>
    ...
    <div class="content-wrapper" style="min-height:2000px !important;">
      ...
      <section>
       ...
       <section>
         <div id="capa_modalHorario" class="div_modal" ></div>
         <div id="capa_para_edicionHorario" class="div_contenido" > <div>
         </section>
